...
TestesRegressaoSVRegressionRBF<-function(ConjuntoTeste, ConjuntoTreino, c, coef, sigma){
  ...
  TestaDiferentesLimiares(predictions, testing$Class, "outputSVMRBF", c, coef, sigma)
  
  # Cria tabela de predicao
  #tb <- table(predictions, testing$Class)
  
  #Grava arquivo
  ##sink(paste('/home/toasty/Desktop/RBooks/Experimentos/Predicao/outputSVMRBF.txt'), append=TRUE)
  #print(tb)
